...
public partial class GameEngine : Node
{
    ...
    /// </summary>
    public InterfaceTestCode Interface { get; private set; }
    /// <summary>
    /// Defines the reference to the <see cref="GameEngine"/>'s <see cref="NetworkManager"/> <see cref="Node"/>.
    /// </summary>
    ...
    public override void _Ready()
    {
        ...
        this.Interface ??= this.GetNode<InterfaceTestCode>("Interface");
        this.Network ??= this.GetNode<NetworkManager>("Network");
